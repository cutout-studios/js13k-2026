...
// TODO: fill in real balance values
export default [
  [ // player
    "White",
    0xFFFFFF,
    [
      [[[undefined, [Z_AXIS, -1.57]], [
        0.44,
        createPyramid([0.14, 0.1, 0.4], 3),
      ]], [[[0.2, -0.02, -0.05], [Z_AXIS, 0.44]], [
        0.3,
        createPrism([0.19, 0.05, 0.02], 3),
      ]], [[[-0.2, -0.02, -0.05], [Z_AXIS, -0.44]], [
        0.3,
        createPrism([0.19, 0.05, 0.02], 3),
      ]], [[[0, -0.03, -0.28], [X_AXIS, 1.57]], [
        0.17,
