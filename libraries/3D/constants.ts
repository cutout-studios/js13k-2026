...
import { XYZ } from "./types.ts";

export const XYZ_LENGTH = 3;

export const X_AXIS: XYZ = [1, 0, 0];
export const Y_AXIS: XYZ = [0, 1, 0];
export const Z_AXIS: XYZ = [0, 0, 1];
...
export const CAMERA_DEFAULT_OBJECT_LIMIT = 512;
